...
const editorialStatSchema = z.object({
  value: z.string().min(1).max(20),
  labelLineOne: z.string().min(1).max(80),
  labelLineTwo: z.string().min(1).max(80),
});

const editorialSchema = z.object({
  siteLabel: z.string().min(1).max(80),
  navHome: z.string().min(1).max(40).default(portfolioContent.editorial.navHome),
  navWork: z.string().min(1).max(40).default(portfolioContent.editorial.navWork),
  navAbout: z.string().min(1).max(40).default(portfolioContent.editorial.navAbout),
  navServices: z.string().min(1).max(40).default(portfolioContent.editorial.navServices),
  navExperience: z.string().min(1).max(40).default(portfolioContent.editorial.navExperience),
  navContact: z.string().min(1).max(40).default(portfolioContent.editorial.navContact),
  menuLabel: z.string().min(1).max(40).default(portfolioContent.editorial.menuLabel),
  availabilityLineOne: z.string().min(1).max(80),
  availabilityLineTwo: z.string().min(1).max(80),
  heroKicker: z.string().min(1).max(160),
  heroTitleLineOne: z.string().min(1).max(80),
  heroTitleLineTwo: z.string().min(1).max(80),
  heroScript: z.string().min(1).max(100),
  heroCta: z.string().min(1).max(80),
  portraitUrl: z.string().min(1).max(2048),
  portraitAlt: z.string().min(1).max(255),
  credibilityHeadline: z.string().min(1).max(300),
  stats: z.array(editorialStatSchema).min(4).max(8),
  workLabel: z.string().min(1).max(160),
  workCta: z.string().min(1).max(100),
  workNote: z.string().min(1).max(700),
  filterLabel: z.string().min(1).max(80).default(portfolioContent.editorial.filterLabel),
  filterAllLabel: z.string().min(1).max(80).default(portfolioContent.editorial.filterAllLabel),
  filterRolePrefix: z.string().min(1).max(80).default(portfolioContent.editorial.filterRolePrefix),
  filterEmptyMessage: z.string().min(1).max(400).default(portfolioContent.editorial.filterEmptyMessage),
  servicesLabel: z.string().min(1).max(160),
  experienceTitle: z.string().min(1).max(160),
  collaborationsLabel: z.string().min(1).max(160),
  contactHeadline: z.string().min(1).max(160),
  contactAvailability: z.string().min(1).max(300),
  contactFallbackLabel: z.string().min(1).max(100).default(portfolioContent.editorial.contactFallbackLabel),
  contactLocationLabel: z.string().min(1).max(100).default(portfolioContent.editorial.contactLocationLabel),
  linkedinDisplayLabel: z.string().min(1).max(160).default(portfolioContent.editorial.linkedinDisplayLabel),
  githubDisplayLabel: z.string().min(1).max(160).default(portfolioContent.editorial.githubDisplayLabel),
  resumeLabel: z.string().min(1).max(100),
  copyEmailLabel: z.string().min(1).max(100),
  emailUnavailableLabel: z.string().min(1).max(100).default(portfolioContent.editorial.emailUnavailableLabel),
  emailCopiedLabel: z.string().min(1).max(100).default(portfolioContent.editorial.emailCopiedLabel),
  emailCopiedMessage: z.string().min(1).max(200).default(portfolioContent.editorial.emailCopiedMessage),
  thanksLabel: z.string().min(1).max(100),
  footerTagline: z.string().min(1).max(160),
  studioLabel: z.string().min(1).max(100).default(portfolioContent.editorial.studioLabel),
});
...
const siteContentSchema = z.object({
  ...
  editorial: editorialSchema.default(portfolioContent.editorial),
  sections: z.object({
